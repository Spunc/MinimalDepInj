function objArray = createObjectArray(s)
%CREATEOBJECTARRAY creates an array of objects of a single class.
%   Use this class in the dependency injection framework
%   (depInj.createObjFromTree()).
%   For the method field, write 'depInj.createObjectArray'. Another field
...
%   config.method = 'depInj.createObjectArray';
